...
/*   Updated: 2025/03/07 16:27:41 by leaugust         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Détermine si un caractère est un caractère spécial dans l'analyse de la commande.
...
1. Parcourt les caractères jusqu'à rencontrer un caractère spécial (défini par is_special_char).
2. L'ajoute comme COMMAND si le mot est le premier dans la ligne (is_first_word est vrai).
3. Réinitialise is_first_word si un PIPE est rencontré avant.
4. L'ajoute comme ARGUMENT s'il n'est pas le premier mot et qu'il commence par un tiret (-).
5. L'ajoute comme STRING s'il n'est pas le premier mot et qu'il ne commence pas par un tiret (-).
